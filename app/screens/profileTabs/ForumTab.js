...
export default function ForumTab() {
  ...
  // State quản lý text bình luận cho từng bài viết
  ...
  const loadPosts = async () => {
    ...
    // Đảm bảo các bài cũ cũng có thuộc tính cần thiết nếu thiếu
  ...
  const handleSendComment = async (postId) => {
    ...
    // Xóa text ở ô input sau khi gửi
